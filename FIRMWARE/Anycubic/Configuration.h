...
#define STRING_CONFIG_H_AUTHOR "(knutwurst, changes by Diani)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if ANY(KNUTWURST_MEGA, KNUTWURST_MEGA_S, KNUTWURST_MEGA_P)
    #define DEFAULT_bedKp 93.96
    #define DEFAULT_bedKi  14.70
    #define DEFAULT_bedKd 400.22
  #endif
 ...
 */
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 408.25 }
#endif
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 29, -15, -0.81 } //X-Carriage
#endif
